...
import {
  ...
  getAllProductSingle,
  getAllProductSingleStatus,
} from "../../store/producrSlice";
...
const ProductSingle = () => {
  ...
  const product = useSelector(getAllProductSingle);
  const productSingleStatus = useSelector(getAllProductSingleStatus);
